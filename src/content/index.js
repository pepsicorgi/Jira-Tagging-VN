(async () => {
    ...
    const srcHelpers = chrome.runtime.getURL('src/content/helpers.js');
    ...
    const { initHelpers, initSubsidiaryLookup } = await import(srcHelpers);

    // 3. Initialize Features
    initCommentFeature(); // This handles the "Templates" dropdown
    initAemShopFeature(); // This handles your AEM/SHOP buttons
    initHelpers(); // This initializes any helper functions
    initSubsidiaryLookup();
